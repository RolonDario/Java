public class Primoss {
    ...
    public static void main(String[] args) {
        // TODO Dado N numeros, indicar si los numeros que van desde el 1 a N (N
        // incluido) son primos o no.
        /*
         * 1 , 2, 3, 4, 5
         * 
         * - Para valores menores a 2 son no primos.
         * - Tenemos que comprobar que dados los valores de 1 a N, que no exista un
         * valor tal que el numero NUMER_EVALUACION % i = 0.
         *
         */
        int numero = 173;
        if (numero <= 2) {
